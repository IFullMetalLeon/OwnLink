...
#region Wrapper specifics
	...
	{
		public const string VERSION = "4.5.0-alpha-82-gb2225d4";
#if __IOS__
...
#region Classes
	...
	public class Core : LinphoneObject
	{
		...
		{
			IEnumerable<Linphone.Friend> returnVal = MarshalBctbxList<Linphone.Friend>(linphone_core_find_friends(nativePtr, address != null ? address.nativePtr : IntPtr.Zero));
		...
		{
			IEnumerable<Linphone.CallLog> returnVal = MarshalBctbxList<Linphone.CallLog>(linphone_core_get_call_history_2(nativePtr, peerAddress != null ? peerAddress.nativePtr : IntPtr.Zero, localAddress != null ? localAddress.nativePtr : IntPtr.Zero));
		...
		{
			IEnumerable<Linphone.CallLog> returnVal = MarshalBctbxList<Linphone.CallLog>(linphone_core_get_call_history_for_address(nativePtr, address != null ? address.nativePtr : IntPtr.Zero));
